...
- 🔄 `Changed` help to show topics for each command. Help is generated by another executable.
- 🛠️ Fixed a bug where `reorder` would allow duplicated indices.
- ❌ Removed experimental `--tool` support.
