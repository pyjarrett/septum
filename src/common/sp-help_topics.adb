...
package body SP.Help_Topics is
    ...
    procedure About (Command_Name : String) is
    begin
        ...
        SP.Help.Block
           ("I also got a bunch of results related to String_Holders, SP.Strings,  Ada.Strings, String_Vectors and functions which return Strings, and string  parameters to subprograms but I don't want those either.  ");
        SP.Help.Block
           ("Also, it looks like the project has a linux specific folder and some other  projects I don't want, so ignore those in the results.  ");
        SP.Help.Plain
        ...
        SP.Help.Plain ("    Matching files: 14");
        SP.Help.Block
           ("We can abbreviate commands with unambiguous prefixes, so  let's shorten `match-contexts` to `match-c`.  ");
    ...
    pragma Style_Checks (Off);
    procedure Usage (Command_Name : String) is
    begin
        pragma Unreferenced (Command_Name);
        SP.Help.Block
    ...
    pragma Style_Checks (Off);
    procedure Line_Filters (Command_Name : String) is
    begin
        pragma Unreferenced (Command_Name);
        SP.Help.Block
    ...
    pragma Style_Checks (Off);
    procedure File_Cache (Command_Name : String) is
    begin
        pragma Unreferenced (Command_Name);
        SP.Help.Block
    ...
    pragma Style_Checks (Off);
    procedure Path_Filters (Command_Name : String) is
    begin
        pragma Unreferenced (Command_Name);
        SP.Help.Block
    ...
    pragma Style_Checks (Off);
    procedure Results (Command_Name : String) is
    begin
        pragma Unreferenced (Command_Name);
        SP.Help.Block
